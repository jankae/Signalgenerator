...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(SPI1_CS_RF_GPIO_Port, SPI1_CS_RF_Pin, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = SPI1_CS_RF_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(SPI1_CS_RF_GPIO_Port, &GPIO_InitStruct);
